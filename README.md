...
这是一个基于 Python 的多智能体系统演示，旨在模拟现代化的医院智能客服场景。系统采用了 **ReAct (Reasoning + Acting)** 架构，结合 **RAG (检索增强生成) ** 技术和 **多模态** 能力，能够通过协调多个专门的智能体来高效服务患者。
...
5.  **Report Agent (报告解读智能体)**: 负责解读检验检查报告（支持上传图片）。
